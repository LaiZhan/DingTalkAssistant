...
{
    /// <summary>
    /// TOP API: wdk.rex.device.info.get
    /// </summary>
    public class WdkRexDeviceInfoGetRequest : BaseTopRequest<Top.Api.Response.WdkRexDeviceInfoGetResponse>
    {
        /// <summary>
        /// ak
        /// </summary>
        ...
        {
            return "wdk.rex.device.info.get";
        }
